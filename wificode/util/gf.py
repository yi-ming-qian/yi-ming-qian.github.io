...
def test_gf():
    import imageio
    assert False, "Check how to constrain it inside valid mask"
    path_guide = "/Users/huayizeng/Desktop/temp/feb7/inter_geo/scene_01597_493_1---scene_01220_264_3_ori_gt_3.jpg"
    guide = imageio.imread(path_guide).astype(np.float32) / 255
    print("guide.shape: ", guide.shape)
    guide = guide[:, :, 0]
    path_shading = "/Users/huayizeng/Desktop/temp/feb7/inter_geo/scene_01597_493_1---scene_01220_264_3_shading_pred_3.jpg"
    shading = imageio.imread(path_shading).astype(np.float32) / 255

    r = 8
    eps = 0.05
    s_smoothed = guided_filter(guide, shading, r, eps)

    imageio.imwrite('s_smoothed.png', s_smoothed)
